...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    1033:	ff 33                	push   (%ebx)
    1035:	e8 8f 03 00 00       	call   13c9 <unlink>
  ...
  exit();
    ...
    1050:	50                   	push   %eax
    1051:	ff 33                	push   (%ebx)
    1053:	68 4c 18 00 00       	push   $0x184c
    1058:	6a 02                	push   $0x2
...
int lock_init(lock_thread *lock)
{
  ...
  printf(1,"12");
    1336:	68 65 18 00 00       	push   $0x1865
    133b:	6a 01                	push   $0x1
  ...
  printf(1,"12");
    134b:	58                   	pop    %eax
    134c:	5a                   	pop    %edx
    134d:	68 65 18 00 00       	push   $0x1865
    1352:	6a 01                	push   $0x1
    ...
    146c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    1499:	0f b6 92 c8 18 00 00 	movzbl 0x18c8(%edx),%edx
    ...
    1519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1589:	ff 24 85 70 18 00 00 	jmp    *0x1870(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    1697:	90                   	nop
          s = "(null)";
    1698:	ba 68 18 00 00       	mov    $0x1868,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    16b1:	a1 20 1c 00 00       	mov    0x1c20,%eax
{
  ...
  freep = p;
    ...
    16f1:	5b                   	pop    %ebx
  freep = p;
    16f2:	89 15 20 1c 00 00    	mov    %edx,0x1c20
}
    16f8:	5e                   	pop    %esi
    16f9:	5f                   	pop    %edi
    16fa:	5d                   	pop    %ebp
  ...
  freep = p;
    172c:	89 15 20 1c 00 00    	mov    %edx,0x1c20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    174c:	8b 3d 20 1c 00 00    	mov    0x1c20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1791:	8b 3d 20 1c 00 00    	mov    0x1c20,%edi
  ...
  return freep;
    17bf:	8b 15 20 1c 00 00    	mov    0x1c20,%edx
    ...
    17ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    17ef:	89 15 20 1c 00 00    	mov    %edx,0x1c20
}
    ...
    17ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1800:	c7 05 20 1c 00 00 24 	movl   $0x1c24,0x1c20
    1807:	1c 00 00 
    base.s.size = 0;
    180a:	bf 24 1c 00 00       	mov    $0x1c24,%edi
    base.s.ptr = freep = prevp = &base;
    180f:	c7 05 24 1c 00 00 24 	movl   $0x1c24,0x1c24
    1816:	1c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    181b:	c7 05 28 1c 00 00 00 	movl   $0x0,0x1c28
    1822:	00 00 00 
    if(p->s.size >= nunits){
