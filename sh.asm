...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    ...
    1024:	6a 02                	push   $0x2
    1026:	68 29 24 00 00       	push   $0x2429
    102b:	e8 d9 0e 00 00       	call   1f09 <open>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    1040:	80 3d 62 2b 00 00 20 	cmpb   $0x20,0x2b62
...
fork1(void)
{
  ...
  pid = fork();
    1050:	e8 6c 0e 00 00       	call   1ec1 <fork>
  if(pid == -1)
    ...
    wait();
    1062:	e8 6a 0e 00 00       	call   1ed1 <wait>
  printf(2, "$ ");
    1067:	83 ec 08             	sub    $0x8,%esp
    106a:	68 88 23 00 00       	push   $0x2388
    106f:	6a 02                	push   $0x2
    1071:	e8 ea 0f 00 00       	call   2060 <printf>
  memset(buf, 0, nbuf);
    1076:	83 c4 0c             	add    $0xc,%esp
    1079:	6a 64                	push   $0x64
    107b:	6a 00                	push   $0x0
    107d:	68 60 2b 00 00       	push   $0x2b60
    1082:	e8 09 0c 00 00       	call   1c90 <memset>
  gets(buf, nbuf);
    1087:	58                   	pop    %eax
    1088:	5a                   	pop    %edx
    1089:	6a 64                	push   $0x64
    108b:	68 60 2b 00 00       	push   $0x2b60
    1090:	e8 5b 0c 00 00       	call   1cf0 <gets>
  if(buf[0] == 0) // EOF
    1095:	0f b6 05 60 2b 00 00 	movzbl 0x2b60,%eax
    ...
    10d8:	68 60 2b 00 00       	push   $0x2b60
    10dd:	e8 7e 0b 00 00       	call   1c60 <strlen>
      if(chdir(buf+3) < 0)
    10e2:	c7 04 24 63 2b 00 00 	movl   $0x2b63,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
    10e9:	c6 80 5f 2b 00 00 00 	movb   $0x0,0x2b5f(%eax)
      if(chdir(buf+3) < 0)
    10f0:	e8 44 0e 00 00       	call   1f39 <chdir>
    10f5:	83 c4 10             	add    $0x10,%esp
    10f8:	85 c0                	test   %eax,%eax
    10fa:	0f 89 67 ff ff ff    	jns    1067 <main+0x67>
        printf(2, "cannot cd %s\n", buf+3);
    1100:	51                   	push   %ecx
    1101:	68 63 2b 00 00       	push   $0x2b63
    1106:	68 31 24 00 00       	push   $0x2431
    110b:	6a 02                	push   $0x2
    110d:	e8 4e 0f 00 00       	call   2060 <printf>
    1112:	83 c4 10             	add    $0x10,%esp
    1115:	e9 4d ff ff ff       	jmp    1067 <main+0x67>
  exit();
    111a:	e8 aa 0d 00 00       	call   1ec9 <exit>
    panic("fork");
    111f:	83 ec 0c             	sub    $0xc,%esp
    1122:	68 8b 23 00 00       	push   $0x238b
...
00001130 <getcmd>:
{
  ...
  printf(2, "$ ");
    ...
    113e:	68 88 23 00 00       	push   $0x2388
    1143:	6a 02                	push   $0x2
    1145:	e8 16 0f 00 00       	call   2060 <printf>
  memset(buf, 0, nbuf);
...
00001170 <panic>:
{
  ...
  printf(2, "%s\n", s);
    ...
    1179:	68 25 24 00 00       	push   $0x2425
    117e:	6a 02                	push   $0x2
    1180:	e8 db 0e 00 00       	call   2060 <printf>
  exit();
    1185:	e8 3f 0d 00 00       	call   1ec9 <exit>
...
00001190 <fork1>:
{
  ...
  pid = fork();
    1196:	e8 26 0d 00 00       	call   1ec1 <fork>
  if(pid == -1)
  ...
  return pid;
    ...
    11a5:	68 8b 23 00 00       	push   $0x238b
...
000011b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    11c9:	ff 24 85 40 24 00 00 	jmp    *0x2440(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    11dc:	52                   	push   %edx
    11dd:	50                   	push   %eax
    11de:	e8 1e 0d 00 00       	call   1f01 <exec>
    printf(2, "exec %s failed\n", ecmd->argv[0]);
    11e3:	83 c4 0c             	add    $0xc,%esp
    11e6:	ff 73 04             	push   0x4(%ebx)
    11e9:	68 97 23 00 00       	push   $0x2397
    11ee:	6a 02                	push   $0x2
    11f0:	e8 6b 0e 00 00       	call   2060 <printf>
    break;
    11f5:	83 c4 10             	add    $0x10,%esp
    11f8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    11ff:	90                   	nop
    exit();
    1200:	e8 c4 0c 00 00       	call   1ec9 <exit>
    if(fork1() == 0)
    ...
    1219:	50                   	push   %eax
    121a:	e8 ba 0c 00 00       	call   1ed9 <pipe>
    ...
    124a:	e8 a2 0c 00 00       	call   1ef1 <close>
    close(p[1]);
    124f:	58                   	pop    %eax
    1250:	ff 75 f4             	push   -0xc(%ebp)
    1253:	e8 99 0c 00 00       	call   1ef1 <close>
    wait();
    1258:	e8 74 0c 00 00       	call   1ed1 <wait>
    wait();
    125d:	e8 6f 0c 00 00       	call   1ed1 <wait>
    break;
    ...
    wait();
    1270:	e8 5c 0c 00 00       	call   1ed1 <wait>
    runcmd(lcmd->right);
    ...
    1286:	e8 66 0c 00 00       	call   1ef1 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
    128b:	58                   	pop    %eax
    128c:	5a                   	pop    %edx
    128d:	ff 73 10             	push   0x10(%ebx)
    1290:	ff 73 08             	push   0x8(%ebx)
    1293:	e8 71 0c 00 00       	call   1f09 <open>
    ...
    12ad:	68 90 23 00 00       	push   $0x2390
    12b2:	e8 b9 fe ff ff       	call   1170 <panic>
      printf(2, "open %s failed\n", rcmd->file);
    12b7:	51                   	push   %ecx
    12b8:	ff 73 08             	push   0x8(%ebx)
    12bb:	68 a7 23 00 00       	push   $0x23a7
    12c0:	6a 02                	push   $0x2
    12c2:	e8 99 0d 00 00       	call   2060 <printf>
      exit();
    12c7:	e8 fd 0b 00 00       	call   1ec9 <exit>
      panic("pipe");
    12cc:	83 ec 0c             	sub    $0xc,%esp
    12cf:	68 b7 23 00 00       	push   $0x23b7
    12d4:	e8 97 fe ff ff       	call   1170 <panic>
      close(1);
    12d9:	83 ec 0c             	sub    $0xc,%esp
    12dc:	6a 01                	push   $0x1
    12de:	e8 0e 0c 00 00       	call   1ef1 <close>
      dup(p[1]);
    12e3:	58                   	pop    %eax
    12e4:	ff 75 f4             	push   -0xc(%ebp)
    12e7:	e8 55 0c 00 00       	call   1f41 <dup>
      close(p[0]);
    12ec:	58                   	pop    %eax
    12ed:	ff 75 f0             	push   -0x10(%ebp)
    12f0:	e8 fc 0b 00 00       	call   1ef1 <close>
      close(p[1]);
    12f5:	58                   	pop    %eax
    12f6:	ff 75 f4             	push   -0xc(%ebp)
    12f9:	e8 f3 0b 00 00       	call   1ef1 <close>
      runcmd(pcmd->left);
    12fe:	5a                   	pop    %edx
    ...
    130a:	6a 00                	push   $0x0
    130c:	e8 e0 0b 00 00       	call   1ef1 <close>
      dup(p[0]);
    1311:	5a                   	pop    %edx
    1312:	ff 75 f0             	push   -0x10(%ebp)
    1315:	e8 27 0c 00 00       	call   1f41 <dup>
      close(p[0]);
    131a:	59                   	pop    %ecx
    131b:	ff 75 f0             	push   -0x10(%ebp)
    131e:	e8 ce 0b 00 00       	call   1ef1 <close>
      close(p[1]);
    1323:	58                   	pop    %eax
    1324:	ff 75 f4             	push   -0xc(%ebp)
    1327:	e8 c5 0b 00 00       	call   1ef1 <close>
      runcmd(pcmd->right);
    132c:	58                   	pop    %eax
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    1349:	e8 42 0f 00 00       	call   2290 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    1379:	e8 12 0f 00 00       	call   2290 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
    13c7:	6a 0c                	push   $0xc
    13c9:	e8 c2 0e 00 00       	call   2290 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
    1407:	6a 0c                	push   $0xc
    1409:	e8 82 0e 00 00       	call   2290 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
    1447:	6a 08                	push   $0x8
    1449:	e8 42 0e 00 00       	call   2290 <malloc>
  memset(cmd, 0, sizeof(*cmd));
    ...
    1479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    149d:	50                   	push   %eax
    149e:	68 50 2b 00 00       	push   $0x2b50
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    14ed:	50                   	push   %eax
    14ee:	68 50 2b 00 00       	push   $0x2b50
  ...
  *ps = s;
  ...
  if(eq)
    ...
    152e:	50                   	push   %eax
    152f:	68 48 2b 00 00       	push   $0x2b48
    ...
    1550:	56                   	push   %esi
    1551:	68 50 2b 00 00       	push   $0x2b50
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    15fd:	50                   	push   %eax
    15fe:	68 50 2b 00 00       	push   $0x2b50
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    1663:	68 d9 23 00 00       	push   $0x23d9
    1668:	53                   	push   %ebx
    1669:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
    16c2:	e8 c9 0b 00 00       	call   2290 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
    1721:	e8 6a 0b 00 00       	call   2290 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
    ...
    177e:	68 bc 23 00 00       	push   $0x23bc
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
    179f:	68 dc 23 00 00       	push   $0x23dc
    17a4:	57                   	push   %edi
    17a5:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    17bd:	e8 ce 0a 00 00       	call   2290 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    1806:	68 f3 23 00 00       	push   $0x23f3
    180b:	57                   	push   %edi
    180c:	56                   	push   %esi
    ...
    1850:	68 e5 23 00 00       	push   $0x23e5
  ...
  cmd->eargv[argc] = 0;
    ...
    1899:	68 de 23 00 00       	push   $0x23de
...
000018b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
    ...
    18c9:	68 f8 23 00 00       	push   $0x23f8
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
    190d:	e8 7e 09 00 00       	call   2290 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00001940 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    1972:	e8 19 09 00 00       	call   2290 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
    ...
    199b:	68 fa 23 00 00       	push   $0x23fa
    19a0:	57                   	push   %edi
    19a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
    ...
    19b1:	68 f6 23 00 00       	push   $0x23f6
    19b6:	57                   	push   %edi
    19b7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
    19ed:	e8 9e 08 00 00       	call   2290 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00001a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
    1a2f:	68 dc 23 00 00       	push   $0x23dc
    1a34:	56                   	push   %esi
    1a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
    ...
    1a59:	68 18 24 00 00       	push   $0x2418
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
    ...
    1ac9:	ff 24 85 58 24 00 00 	jmp    *0x2458(,%eax,4)
    ...
    1b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
    ...
    1b83:	68 a6 23 00 00       	push   $0x23a6
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    1bae:	52                   	push   %edx
    1baf:	50                   	push   %eax
    1bb0:	68 1a 24 00 00       	push   $0x241a
    1bb5:	6a 02                	push   $0x2
    1bb7:	e8 a4 04 00 00       	call   2060 <printf>
    panic("syntax");
    1bbc:	c7 04 24 de 23 00 00 	movl   $0x23de,(%esp)
    ...
    1cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    1d05:	57                   	push   %edi
    1d06:	6a 00                	push   $0x0
    1d08:	e8 d4 01 00 00       	call   1ee1 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    1d6d:	e8 97 01 00 00       	call   1f09 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    1d81:	50                   	push   %eax
    1d82:	e8 9a 01 00 00       	call   1f21 <fstat>
  close(fd);
    1d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    1d8a:	89 c6                	mov    %eax,%esi
  close(fd);
    1d8c:	e8 60 01 00 00       	call   1ef1 <close>
  return r;
...
memmove(void *vdst, const void *vsrc, int n)
{
  ...
  return vdst;
    ...
    1e19:	5d                   	pop    %ebp
    1e1a:	c3                   	ret    
    1e1b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    1e1f:	90                   	nop

00001e20 <thread_create>:

int thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
    1e20:	55                   	push   %ebp
    1e21:	89 e5                	mov    %esp,%ebp
    1e23:	83 ec 14             	sub    $0x14,%esp
  void* stack;
  stack = malloc(PGSIZE);
    1e26:	68 00 10 00 00       	push   $0x1000
    1e2b:	e8 60 04 00 00       	call   2290 <malloc>
  return clone(start_routine, arg1, arg2, stack);
    1e30:	50                   	push   %eax
    1e31:	ff 75 10             	push   0x10(%ebp)
    1e34:	ff 75 0c             	push   0xc(%ebp)
    1e37:	ff 75 08             	push   0x8(%ebp)
    1e3a:	e8 42 01 00 00       	call   1f81 <clone>
}
    1e3f:	c9                   	leave  
    1e40:	c3                   	ret    
    1e41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1e48:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1e4f:	90                   	nop

00001e50 <lock_acquire>:
...
xchg(volatile uint *addr, uint newval)
{
  ...
  asm volatile("lock; xchgl %0, %1" :
    1e51:	b9 01 00 00 00       	mov    $0x1,%ecx
    1e56:	89 e5                	mov    %esp,%ebp
    1e58:	8b 55 08             	mov    0x8(%ebp),%edx
    1e5b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    1e5f:	90                   	nop
    1e60:	89 c8                	mov    %ecx,%eax
    1e62:	f0 87 02             	lock xchg %eax,(%edx)
  while(xchg(&lock->locked, 1) != 0);
    1e65:	85 c0                	test   %eax,%eax
    1e67:	75 f7                	jne    1e60 <lock_acquire+0x10>
}
    1e69:	5d                   	pop    %ebp
    1e6a:	c3                   	ret    
...
int lock_init(lock_thread *lock)
{
    ...
    1e83:	83 ec 10             	sub    $0x10,%esp
  printf(1,"12");
    1e86:	68 70 24 00 00       	push   $0x2470
    1e8b:	6a 01                	push   $0x1
    1e8d:	e8 ce 01 00 00       	call   2060 <printf>
  lock->locked = 0;
    1e92:	8b 45 08             	mov    0x8(%ebp),%eax
    1e95:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  printf(1,"12");
    1e9b:	58                   	pop    %eax
    1e9c:	5a                   	pop    %edx
    1e9d:	68 70 24 00 00       	push   $0x2470
    1ea2:	6a 01                	push   $0x1
    1ea4:	e8 b7 01 00 00       	call   2060 <printf>
  return 0;
}
    1ea9:	31 c0                	xor    %eax,%eax
    1eab:	c9                   	leave  
    1eac:	c3                   	ret    
    1ead:	8d 76 00             	lea    0x0(%esi),%esi

00001eb0 <thread_join>:
...
int thread_join()
{
    ...
    1eb3:	83 ec 24             	sub    $0x24,%esp
  void * stackPtr;
  int a = join(&stackPtr);
    1eb6:	8d 45 f4             	lea    -0xc(%ebp),%eax
    1eb9:	50                   	push   %eax
    1eba:	e8 ca 00 00 00       	call   1f89 <join>
  return a;
    1ebf:	c9                   	leave  
    1ec0:	c3                   	ret    
...
SYSCALL(fork)
    1ec1:	b8 01 00 00 00       	mov    $0x1,%eax
    1ec6:	cd 40                	int    $0x40
    1ec8:	c3                   	ret    

00001ec9 <exit>:
SYSCALL(exit)
    1ec9:	b8 02 00 00 00       	mov    $0x2,%eax
    1ece:	cd 40                	int    $0x40
    1ed0:	c3                   	ret    

00001ed1 <wait>:
SYSCALL(wait)
    1ed1:	b8 03 00 00 00       	mov    $0x3,%eax
    1ed6:	cd 40                	int    $0x40
    1ed8:	c3                   	ret    

00001ed9 <pipe>:
SYSCALL(pipe)
    1ed9:	b8 04 00 00 00       	mov    $0x4,%eax
    1ede:	cd 40                	int    $0x40
    1ee0:	c3                   	ret    

00001ee1 <read>:
SYSCALL(read)
    1ee1:	b8 05 00 00 00       	mov    $0x5,%eax
    1ee6:	cd 40                	int    $0x40
    1ee8:	c3                   	ret    

00001ee9 <write>:
SYSCALL(write)
    1ee9:	b8 10 00 00 00       	mov    $0x10,%eax
    1eee:	cd 40                	int    $0x40
    1ef0:	c3                   	ret    

00001ef1 <close>:
SYSCALL(close)
    1ef1:	b8 15 00 00 00       	mov    $0x15,%eax
    1ef6:	cd 40                	int    $0x40
    1ef8:	c3                   	ret    

00001ef9 <kill>:
SYSCALL(kill)
    1ef9:	b8 06 00 00 00       	mov    $0x6,%eax
    1efe:	cd 40                	int    $0x40
    1f00:	c3                   	ret    

00001f01 <exec>:
SYSCALL(exec)
    1f01:	b8 07 00 00 00       	mov    $0x7,%eax
    1f06:	cd 40                	int    $0x40
    1f08:	c3                   	ret    

00001f09 <open>:
SYSCALL(open)
    1f09:	b8 0f 00 00 00       	mov    $0xf,%eax
    1f0e:	cd 40                	int    $0x40
    1f10:	c3                   	ret    

00001f11 <mknod>:
SYSCALL(mknod)
    1f11:	b8 11 00 00 00       	mov    $0x11,%eax
    1f16:	cd 40                	int    $0x40
    1f18:	c3                   	ret    

00001f19 <unlink>:
SYSCALL(unlink)
    1f19:	b8 12 00 00 00       	mov    $0x12,%eax
    1f1e:	cd 40                	int    $0x40
    1f20:	c3                   	ret    

00001f21 <fstat>:
SYSCALL(fstat)
    1f21:	b8 08 00 00 00       	mov    $0x8,%eax
    1f26:	cd 40                	int    $0x40
    1f28:	c3                   	ret    

00001f29 <link>:
SYSCALL(link)
    1f29:	b8 13 00 00 00       	mov    $0x13,%eax
    1f2e:	cd 40                	int    $0x40
    1f30:	c3                   	ret    

00001f31 <mkdir>:
SYSCALL(mkdir)
    1f31:	b8 14 00 00 00       	mov    $0x14,%eax
    1f36:	cd 40                	int    $0x40
    1f38:	c3                   	ret    

00001f39 <chdir>:
SYSCALL(chdir)
    1f39:	b8 09 00 00 00       	mov    $0x9,%eax
    1f3e:	cd 40                	int    $0x40
    1f40:	c3                   	ret    

00001f41 <dup>:
SYSCALL(dup)
    1f41:	b8 0a 00 00 00       	mov    $0xa,%eax
    1f46:	cd 40                	int    $0x40
    1f48:	c3                   	ret    

00001f49 <getpid>:
SYSCALL(getpid)
    1f49:	b8 0b 00 00 00       	mov    $0xb,%eax
    1f4e:	cd 40                	int    $0x40
    1f50:	c3                   	ret    

00001f51 <sbrk>:
SYSCALL(sbrk)
    1f51:	b8 0c 00 00 00       	mov    $0xc,%eax
    1f56:	cd 40                	int    $0x40
    1f58:	c3                   	ret    

00001f59 <sleep>:
SYSCALL(sleep)
    1f59:	b8 0d 00 00 00       	mov    $0xd,%eax
    1f5e:	cd 40                	int    $0x40
    1f60:	c3                   	ret    

00001f61 <uptime>:
SYSCALL(uptime)
    1f61:	b8 0e 00 00 00       	mov    $0xe,%eax
    1f66:	cd 40                	int    $0x40
    1f68:	c3                   	ret    

00001f69 <getreadcount>:
SYSCALL(getreadcount)
    1f69:	b8 16 00 00 00       	mov    $0x16,%eax
    1f6e:	cd 40                	int    $0x40
    1f70:	c3                   	ret    

00001f71 <settickets>:
SYSCALL(settickets)
    1f71:	b8 17 00 00 00       	mov    $0x17,%eax
    1f76:	cd 40                	int    $0x40
    1f78:	c3                   	ret    

00001f79 <getpinfo>:
SYSCALL(getpinfo)
    1f79:	b8 18 00 00 00       	mov    $0x18,%eax
    1f7e:	cd 40                	int    $0x40
    1f80:	c3                   	ret    

00001f81 <clone>:
SYSCALL(clone)
    1f81:	b8 19 00 00 00       	mov    $0x19,%eax
    1f86:	cd 40                	int    $0x40
    1f88:	c3                   	ret    

00001f89 <join>:
SYSCALL(join)
    1f89:	b8 1a 00 00 00       	mov    $0x1a,%eax
    1f8e:	cd 40                	int    $0x40
    1f90:	c3                   	ret    

00001f91 <mprotect>:
SYSCALL(mprotect)
    1f91:	b8 1b 00 00 00       	mov    $0x1b,%eax
    1f96:	cd 40                	int    $0x40
    1f98:	c3                   	ret    

00001f99 <munprotect>:
SYSCALL(munprotect)
    1f99:	b8 1c 00 00 00       	mov    $0x1c,%eax
    1f9e:	cd 40                	int    $0x40
    1fa0:	c3                   	ret    
    1fa1:	66 90                	xchg   %ax,%ax
    1fa3:	66 90                	xchg   %ax,%ax
    1fa5:	66 90                	xchg   %ax,%ax
    1fa7:	66 90                	xchg   %ax,%ax
    1fa9:	66 90                	xchg   %ax,%ax
    1fab:	66 90                	xchg   %ax,%ax
    1fad:	66 90                	xchg   %ax,%ax
    1faf:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    1fb4:	56                   	push   %esi
    1fb5:	53                   	push   %ebx
    1fb6:	83 ec 3c             	sub    $0x3c,%esp
    1fb9:	89 4d c4             	mov    %ecx,-0x3c(%ebp)
  uint x;
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
    1fbc:	89 d1                	mov    %edx,%ecx
{
    1fbe:	89 45 b8             	mov    %eax,-0x48(%ebp)
  if(sgn && xx < 0){
    1fc1:	85 d2                	test   %edx,%edx
    1fc3:	0f 89 7f 00 00 00    	jns    2048 <printint+0x98>
    1fc9:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    1fcd:	74 79                	je     2048 <printint+0x98>
    neg = 1;
    1fcf:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
    x = -xx;
    1fd6:	f7 d9                	neg    %ecx
  } else {
    x = xx;
  ...
  i = 0;
    1fd8:	31 db                	xor    %ebx,%ebx
    1fda:	8d 75 d7             	lea    -0x29(%ebp),%esi
    1fdd:	8d 76 00             	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    1fe0:	89 c8                	mov    %ecx,%eax
    1fe2:	31 d2                	xor    %edx,%edx
    1fe4:	89 cf                	mov    %ecx,%edi
    1fe6:	f7 75 c4             	divl   -0x3c(%ebp)
    1fe9:	0f b6 92 d4 24 00 00 	movzbl 0x24d4(%edx),%edx
    1ff0:	89 45 c0             	mov    %eax,-0x40(%ebp)
    1ff3:	89 d8                	mov    %ebx,%eax
    1ff5:	8d 5b 01             	lea    0x1(%ebx),%ebx
  }while((x /= base) != 0);
    1ff8:	8b 4d c0             	mov    -0x40(%ebp),%ecx
    buf[i++] = digits[x % base];
    1ffb:	88 14 1e             	mov    %dl,(%esi,%ebx,1)
  }while((x /= base) != 0);
    1ffe:	39 7d c4             	cmp    %edi,-0x3c(%ebp)
    2001:	76 dd                	jbe    1fe0 <printint+0x30>
  if(neg)
    2003:	8b 4d bc             	mov    -0x44(%ebp),%ecx
    2006:	85 c9                	test   %ecx,%ecx
    2008:	74 0c                	je     2016 <printint+0x66>
    buf[i++] = '-';
    200a:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    buf[i++] = digits[x % base];
    200f:	89 d8                	mov    %ebx,%eax
    buf[i++] = '-';
    2011:	ba 2d 00 00 00       	mov    $0x2d,%edx

  while(--i >= 0)
    2016:	8b 7d b8             	mov    -0x48(%ebp),%edi
    2019:	8d 5c 05 d7          	lea    -0x29(%ebp,%eax,1),%ebx
    201d:	eb 07                	jmp    2026 <printint+0x76>
    201f:	90                   	nop
    putc(fd, buf[i]);
    2020:	0f b6 13             	movzbl (%ebx),%edx
    2023:	83 eb 01             	sub    $0x1,%ebx
  write(fd, &c, 1);
    2026:	83 ec 04             	sub    $0x4,%esp
    2029:	88 55 d7             	mov    %dl,-0x29(%ebp)
    202c:	6a 01                	push   $0x1
    202e:	56                   	push   %esi
    202f:	57                   	push   %edi
    2030:	e8 b4 fe ff ff       	call   1ee9 <write>
  while(--i >= 0)
    2035:	83 c4 10             	add    $0x10,%esp
    2038:	39 de                	cmp    %ebx,%esi
    203a:	75 e4                	jne    2020 <printint+0x70>
}
    203c:	8d 65 f4             	lea    -0xc(%ebp),%esp
    203f:	5b                   	pop    %ebx
    2040:	5e                   	pop    %esi
    2041:	5f                   	pop    %edi
    2042:	5d                   	pop    %ebp
    2043:	c3                   	ret    
    2044:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  neg = 0;
    2048:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
    204f:	eb 87                	jmp    1fd8 <printint+0x28>
    2051:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    2058:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    205f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    2069:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
    206c:	8b 75 08             	mov    0x8(%ebp),%esi
  for(i = 0; fmt[i]; i++){
    206f:	0f b6 13             	movzbl (%ebx),%edx
    2072:	84 d2                	test   %dl,%dl
    2074:	74 6a                	je     20e0 <printf+0x80>
  ap = (uint*)(void*)&fmt + 1;
    2076:	8d 45 10             	lea    0x10(%ebp),%eax
    2079:	83 c3 01             	add    $0x1,%ebx
  write(fd, &c, 1);
    207c:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
    207f:	31 c9                	xor    %ecx,%ecx
  ap = (uint*)(void*)&fmt + 1;
    2081:	89 45 d0             	mov    %eax,-0x30(%ebp)
    2084:	eb 36                	jmp    20bc <printf+0x5c>
    2086:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    208d:	8d 76 00             	lea    0x0(%esi),%esi
    2090:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    2093:	b9 25 00 00 00       	mov    $0x25,%ecx
      if(c == '%'){
    2098:	83 f8 25             	cmp    $0x25,%eax
    209b:	74 15                	je     20b2 <printf+0x52>
  write(fd, &c, 1);
    209d:	83 ec 04             	sub    $0x4,%esp
    20a0:	88 55 e7             	mov    %dl,-0x19(%ebp)
    20a3:	6a 01                	push   $0x1
    20a5:	57                   	push   %edi
    20a6:	56                   	push   %esi
    20a7:	e8 3d fe ff ff       	call   1ee9 <write>
    20ac:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
      } else {
        putc(fd, c);
    20af:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    20b2:	0f b6 13             	movzbl (%ebx),%edx
    20b5:	83 c3 01             	add    $0x1,%ebx
    20b8:	84 d2                	test   %dl,%dl
    20ba:	74 24                	je     20e0 <printf+0x80>
    c = fmt[i] & 0xff;
    20bc:	0f b6 c2             	movzbl %dl,%eax
    if(state == 0){
    20bf:	85 c9                	test   %ecx,%ecx
    20c1:	74 cd                	je     2090 <printf+0x30>
      }
    } else if(state == '%'){
    20c3:	83 f9 25             	cmp    $0x25,%ecx
    20c6:	75 ea                	jne    20b2 <printf+0x52>
      if(c == 'd'){
    20c8:	83 f8 25             	cmp    $0x25,%eax
    20cb:	0f 84 07 01 00 00    	je     21d8 <printf+0x178>
    20d1:	83 e8 63             	sub    $0x63,%eax
    20d4:	83 f8 15             	cmp    $0x15,%eax
    20d7:	77 17                	ja     20f0 <printf+0x90>
    20d9:	ff 24 85 7c 24 00 00 	jmp    *0x247c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
    ...
    20e0:	8d 65 f4             	lea    -0xc(%ebp),%esp
    20e3:	5b                   	pop    %ebx
    20e4:	5e                   	pop    %esi
    20e5:	5f                   	pop    %edi
    20e6:	5d                   	pop    %ebp
    20e7:	c3                   	ret    
    20e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    20ef:	90                   	nop
  write(fd, &c, 1);
    20f0:	83 ec 04             	sub    $0x4,%esp
    20f3:	88 55 d4             	mov    %dl,-0x2c(%ebp)
    20f6:	6a 01                	push   $0x1
    20f8:	57                   	push   %edi
    20f9:	56                   	push   %esi
    20fa:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    20fe:	e8 e6 fd ff ff       	call   1ee9 <write>
        putc(fd, c);
    2103:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
  write(fd, &c, 1);
    2107:	83 c4 0c             	add    $0xc,%esp
    210a:	88 55 e7             	mov    %dl,-0x19(%ebp)
    210d:	6a 01                	push   $0x1
    210f:	57                   	push   %edi
    2110:	56                   	push   %esi
    2111:	e8 d3 fd ff ff       	call   1ee9 <write>
        putc(fd, c);
    2116:	83 c4 10             	add    $0x10,%esp
      state = 0;
    2119:	31 c9                	xor    %ecx,%ecx
    211b:	eb 95                	jmp    20b2 <printf+0x52>
    211d:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    2120:	83 ec 0c             	sub    $0xc,%esp
    2123:	b9 10 00 00 00       	mov    $0x10,%ecx
    2128:	6a 00                	push   $0x0
    212a:	8b 45 d0             	mov    -0x30(%ebp),%eax
    212d:	8b 10                	mov    (%eax),%edx
    212f:	89 f0                	mov    %esi,%eax
    2131:	e8 7a fe ff ff       	call   1fb0 <printint>
        ap++;
    2136:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    213a:	83 c4 10             	add    $0x10,%esp
      state = 0;
    213d:	31 c9                	xor    %ecx,%ecx
    213f:	e9 6e ff ff ff       	jmp    20b2 <printf+0x52>
    2144:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    2148:	8b 45 d0             	mov    -0x30(%ebp),%eax
    214b:	8b 10                	mov    (%eax),%edx
        ap++;
    214d:	83 c0 04             	add    $0x4,%eax
    2150:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    2153:	85 d2                	test   %edx,%edx
    2155:	0f 84 8d 00 00 00    	je     21e8 <printf+0x188>
        while(*s != 0){
    215b:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
    215e:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
    2160:	84 c0                	test   %al,%al
    2162:	0f 84 4a ff ff ff    	je     20b2 <printf+0x52>
    2168:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    216b:	89 d3                	mov    %edx,%ebx
    216d:	8d 76 00             	lea    0x0(%esi),%esi
  write(fd, &c, 1);
    2170:	83 ec 04             	sub    $0x4,%esp
          s++;
    2173:	83 c3 01             	add    $0x1,%ebx
    2176:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    2179:	6a 01                	push   $0x1
    217b:	57                   	push   %edi
    217c:	56                   	push   %esi
    217d:	e8 67 fd ff ff       	call   1ee9 <write>
        while(*s != 0){
    2182:	0f b6 03             	movzbl (%ebx),%eax
    2185:	83 c4 10             	add    $0x10,%esp
    2188:	84 c0                	test   %al,%al
    218a:	75 e4                	jne    2170 <printf+0x110>
      state = 0;
    218c:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
    218f:	31 c9                	xor    %ecx,%ecx
    2191:	e9 1c ff ff ff       	jmp    20b2 <printf+0x52>
    2196:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    219d:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
    21a0:	83 ec 0c             	sub    $0xc,%esp
    21a3:	b9 0a 00 00 00       	mov    $0xa,%ecx
    21a8:	6a 01                	push   $0x1
    21aa:	e9 7b ff ff ff       	jmp    212a <printf+0xca>
    21af:	90                   	nop
        putc(fd, *ap);
    21b0:	8b 45 d0             	mov    -0x30(%ebp),%eax
  write(fd, &c, 1);
  ...
  write(fd, &c, 1);
    ...
    21bb:	56                   	push   %esi
        putc(fd, *ap);
    21bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    21bf:	e8 25 fd ff ff       	call   1ee9 <write>
        ap++;
    21c4:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    21c8:	83 c4 10             	add    $0x10,%esp
      state = 0;
    21cb:	31 c9                	xor    %ecx,%ecx
    21cd:	e9 e0 fe ff ff       	jmp    20b2 <printf+0x52>
    21d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        putc(fd, c);
    21d8:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    21db:	83 ec 04             	sub    $0x4,%esp
    21de:	e9 2a ff ff ff       	jmp    210d <printf+0xad>
    21e3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    21e7:	90                   	nop
          s = "(null)";
    21e8:	ba 73 24 00 00       	mov    $0x2473,%edx
        while(*s != 0){
    21ed:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    21f0:	b8 28 00 00 00       	mov    $0x28,%eax
    21f5:	89 d3                	mov    %edx,%ebx
    21f7:	e9 74 ff ff ff       	jmp    2170 <printf+0x110>
    21fc:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    2201:	a1 c4 2b 00 00       	mov    0x2bc4,%eax
{
    2206:	89 e5                	mov    %esp,%ebp
    2208:	57                   	push   %edi
    2209:	56                   	push   %esi
    220a:	53                   	push   %ebx
    220b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  bp = (Header*)ap - 1;
    220e:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    2211:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    2218:	89 c2                	mov    %eax,%edx
    221a:	8b 00                	mov    (%eax),%eax
    221c:	39 ca                	cmp    %ecx,%edx
    221e:	73 30                	jae    2250 <free+0x50>
    2220:	39 c1                	cmp    %eax,%ecx
    2222:	72 04                	jb     2228 <free+0x28>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    2224:	39 c2                	cmp    %eax,%edx
    2226:	72 f0                	jb     2218 <free+0x18>
      break;
  if(bp + bp->s.size == p->s.ptr){
    2228:	8b 73 fc             	mov    -0x4(%ebx),%esi
    222b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    222e:	39 f8                	cmp    %edi,%eax
    2230:	74 30                	je     2262 <free+0x62>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    2232:	89 43 f8             	mov    %eax,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    2235:	8b 42 04             	mov    0x4(%edx),%eax
    2238:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    223b:	39 f1                	cmp    %esi,%ecx
    223d:	74 3a                	je     2279 <free+0x79>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    223f:	89 0a                	mov    %ecx,(%edx)
  } else
    p->s.ptr = bp;
  freep = p;
}
    2241:	5b                   	pop    %ebx
  freep = p;
    2242:	89 15 c4 2b 00 00    	mov    %edx,0x2bc4
}
    2248:	5e                   	pop    %esi
    2249:	5f                   	pop    %edi
    224a:	5d                   	pop    %ebp
    224b:	c3                   	ret    
    224c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    2250:	39 c2                	cmp    %eax,%edx
    2252:	72 c4                	jb     2218 <free+0x18>
    2254:	39 c1                	cmp    %eax,%ecx
    2256:	73 c0                	jae    2218 <free+0x18>
  if(bp + bp->s.size == p->s.ptr){
    2258:	8b 73 fc             	mov    -0x4(%ebx),%esi
    225b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    225e:	39 f8                	cmp    %edi,%eax
    2260:	75 d0                	jne    2232 <free+0x32>
    bp->s.size += p->s.ptr->s.size;
    2262:	03 70 04             	add    0x4(%eax),%esi
    2265:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    2268:	8b 02                	mov    (%edx),%eax
    226a:	8b 00                	mov    (%eax),%eax
    226c:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    226f:	8b 42 04             	mov    0x4(%edx),%eax
    2272:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    2275:	39 f1                	cmp    %esi,%ecx
    2277:	75 c6                	jne    223f <free+0x3f>
    p->s.size += bp->s.size;
    2279:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
    227c:	89 15 c4 2b 00 00    	mov    %edx,0x2bc4
    p->s.size += bp->s.size;
    2282:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    2285:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    2288:	89 0a                	mov    %ecx,(%edx)
}
    228a:	5b                   	pop    %ebx
    228b:	5e                   	pop    %esi
    228c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    229c:	8b 3d c4 2b 00 00    	mov    0x2bc4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    22a2:	8d 70 07             	lea    0x7(%eax),%esi
    22a5:	c1 ee 03             	shr    $0x3,%esi
    22a8:	83 c6 01             	add    $0x1,%esi
  if((prevp = freep) == 0){
    22ab:	85 ff                	test   %edi,%edi
    22ad:	0f 84 9d 00 00 00    	je     2350 <malloc+0xc0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    22b3:	8b 17                	mov    (%edi),%edx
    if(p->s.size >= nunits){
    22b5:	8b 4a 04             	mov    0x4(%edx),%ecx
    22b8:	39 f1                	cmp    %esi,%ecx
    22ba:	73 6a                	jae    2326 <malloc+0x96>
    22bc:	bb 00 10 00 00       	mov    $0x1000,%ebx
    22c1:	39 de                	cmp    %ebx,%esi
    22c3:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    22c6:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    22cd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    22d0:	eb 17                	jmp    22e9 <malloc+0x59>
    22d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    22d8:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    22da:	8b 48 04             	mov    0x4(%eax),%ecx
    22dd:	39 f1                	cmp    %esi,%ecx
    22df:	73 4f                	jae    2330 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    22e1:	8b 3d c4 2b 00 00    	mov    0x2bc4,%edi
    22e7:	89 c2                	mov    %eax,%edx
    22e9:	39 d7                	cmp    %edx,%edi
    22eb:	75 eb                	jne    22d8 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    22ed:	83 ec 0c             	sub    $0xc,%esp
    22f0:	ff 75 e4             	push   -0x1c(%ebp)
    22f3:	e8 59 fc ff ff       	call   1f51 <sbrk>
  if(p == (char*)-1)
    22f8:	83 c4 10             	add    $0x10,%esp
    22fb:	83 f8 ff             	cmp    $0xffffffff,%eax
    22fe:	74 1c                	je     231c <malloc+0x8c>
  hp->s.size = nu;
    2300:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    2303:	83 ec 0c             	sub    $0xc,%esp
    2306:	83 c0 08             	add    $0x8,%eax
    2309:	50                   	push   %eax
    230a:	e8 f1 fe ff ff       	call   2200 <free>
  return freep;
    230f:	8b 15 c4 2b 00 00    	mov    0x2bc4,%edx
      if((p = morecore(nunits)) == 0)
    2315:	83 c4 10             	add    $0x10,%esp
    2318:	85 d2                	test   %edx,%edx
    231a:	75 bc                	jne    22d8 <malloc+0x48>
        return 0;
  }
}
    231c:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    2325:	c3                   	ret    
    if(p->s.size >= nunits){
    2326:	89 d0                	mov    %edx,%eax
    2328:	89 fa                	mov    %edi,%edx
    232a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    2330:	39 ce                	cmp    %ecx,%esi
    2332:	74 4c                	je     2380 <malloc+0xf0>
        p->s.size -= nunits;
    2334:	29 f1                	sub    %esi,%ecx
    2336:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    2339:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    233c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    233f:	89 15 c4 2b 00 00    	mov    %edx,0x2bc4
}
    2345:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    2348:	83 c0 08             	add    $0x8,%eax
}
    234b:	5b                   	pop    %ebx
    234c:	5e                   	pop    %esi
    234d:	5f                   	pop    %edi
    ...
    234f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    2350:	c7 05 c4 2b 00 00 c8 	movl   $0x2bc8,0x2bc4
    2357:	2b 00 00 
    base.s.size = 0;
    235a:	bf c8 2b 00 00       	mov    $0x2bc8,%edi
    base.s.ptr = freep = prevp = &base;
    235f:	c7 05 c8 2b 00 00 c8 	movl   $0x2bc8,0x2bc8
    2366:	2b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    2369:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    236b:	c7 05 cc 2b 00 00 00 	movl   $0x0,0x2bcc
    2372:	00 00 00 
    if(p->s.size >= nunits){
    2375:	e9 42 ff ff ff       	jmp    22bc <malloc+0x2c>
    237a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    2380:	8b 08                	mov    (%eax),%ecx
    2382:	89 0a                	mov    %ecx,(%edx)
    2384:	eb b9                	jmp    233f <malloc+0xaf>
