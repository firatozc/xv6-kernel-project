...
main(int argc, char **argv)
{
  ...
  for(i=1; i<argc; i++)
    ...
    1039:	e8 4b 03 00 00       	call   1389 <kill>
  for(i=1; i<argc; i++)
    103e:	83 c4 10             	add    $0x10,%esp
    1041:	39 de                	cmp    %ebx,%esi
    1043:	75 e3                	jne    1028 <main+0x28>
  exit();
    1045:	e8 0f 03 00 00       	call   1359 <exit>
    printf(2, "usage: kill pid...\n");
    104a:	50                   	push   %eax
    104b:	50                   	push   %eax
    104c:	68 18 18 00 00       	push   $0x1818
    1051:	6a 02                	push   $0x2
    1053:	e8 98 04 00 00       	call   14f0 <printf>
    exit();
    1058:	e8 fc 02 00 00       	call   1359 <exit>
...
int lock_init(lock_thread *lock)
{
  ...
  printf(1,"12");
    1316:	68 2c 18 00 00       	push   $0x182c
    131b:	6a 01                	push   $0x1
  ...
  printf(1,"12");
    132b:	58                   	pop    %eax
    132c:	5a                   	pop    %edx
    132d:	68 2c 18 00 00       	push   $0x182c
    1332:	6a 01                	push   $0x1
    ...
    144c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    1479:	0f b6 92 90 18 00 00 	movzbl 0x1890(%edx),%edx
    ...
    14f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1569:	ff 24 85 38 18 00 00 	jmp    *0x1838(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    1677:	90                   	nop
          s = "(null)";
    1678:	ba 2f 18 00 00       	mov    $0x182f,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1691:	a1 e8 1b 00 00       	mov    0x1be8,%eax
{
  ...
  freep = p;
    ...
    16d1:	5b                   	pop    %ebx
  freep = p;
    16d2:	89 15 e8 1b 00 00    	mov    %edx,0x1be8
}
    16d8:	5e                   	pop    %esi
    16d9:	5f                   	pop    %edi
    16da:	5d                   	pop    %ebp
  ...
  freep = p;
    170c:	89 15 e8 1b 00 00    	mov    %edx,0x1be8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    172c:	8b 3d e8 1b 00 00    	mov    0x1be8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1771:	8b 3d e8 1b 00 00    	mov    0x1be8,%edi
  ...
  return freep;
    179f:	8b 15 e8 1b 00 00    	mov    0x1be8,%edx
    ...
    17cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    17cf:	89 15 e8 1b 00 00    	mov    %edx,0x1be8
}
    ...
    17df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    17e0:	c7 05 e8 1b 00 00 ec 	movl   $0x1bec,0x1be8
    17e7:	1b 00 00 
    base.s.size = 0;
    17ea:	bf ec 1b 00 00       	mov    $0x1bec,%edi
    base.s.ptr = freep = prevp = &base;
    17ef:	c7 05 ec 1b 00 00 ec 	movl   $0x1bec,0x1bec
    17f6:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    17f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    17fb:	c7 05 f0 1b 00 00 00 	movl   $0x0,0x1bf0
    1802:	00 00 00 
    if(p->s.size >= nunits){
