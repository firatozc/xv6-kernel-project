...
_munprotectTest:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  char *addr = malloc(4096);
    ...
    1017:	e8 54 07 00 00       	call   1770 <malloc>
  if (addr == 0) {
    101c:	83 c4 10             	add    $0x10,%esp
    101f:	85 c0                	test   %eax,%eax
    1021:	74 5d                	je     1080 <main+0x80>
  ...
  printf(1, "Allocated page at address %p\n", addr);
    ...
    1028:	50                   	push   %eax
    1029:	68 7e 18 00 00       	push   $0x187e
    102e:	6a 01                	push   $0x1
    1030:	e8 0b 05 00 00       	call   1540 <printf>
  if (mprotect(addr, 1) < 0) {
    1035:	58                   	pop    %eax
    1036:	5a                   	pop    %edx
    1037:	6a 01                	push   $0x1
    1039:	53                   	push   %ebx
    103a:	e8 32 04 00 00       	call   1471 <mprotect>
    103f:	83 c4 10             	add    $0x10,%esp
    1042:	85 c0                	test   %eax,%eax
    1044:	78 27                	js     106d <main+0x6d>
  ...
  if (munprotect(addr, 1)<0) {
    ...
    1048:	6a 01                	push   $0x1
    104a:	53                   	push   %ebx
    104b:	e8 29 04 00 00       	call   1479 <munprotect>
    1050:	83 c4 10             	add    $0x10,%esp
    1053:	85 c0                	test   %eax,%eax
    1055:	78 3c                	js     1093 <main+0x93>
    printf(1, "Error munprotect failed\n");
  }
  addr[0]='A';
    1057:	c6 03 41             	movb   $0x41,(%ebx)
  printf(1, "munprotect test passed\n");
    105a:	50                   	push   %eax
    105b:	50                   	push   %eax
    105c:	68 cd 18 00 00       	push   $0x18cd
    1061:	6a 01                	push   $0x1
    1063:	e8 d8 04 00 00       	call   1540 <printf>
  exit();
    1068:	e8 3c 03 00 00       	call   13a9 <exit>
    printf(1, "Error: mprotect failed\n");
    106d:	53                   	push   %ebx
    106e:	53                   	push   %ebx
    106f:	68 9c 18 00 00       	push   $0x189c
    1074:	6a 01                	push   $0x1
    1076:	e8 c5 04 00 00       	call   1540 <printf>
    exit();
    107b:	e8 29 03 00 00       	call   13a9 <exit>
    printf(1, "Error: malloc failed\n");
    1080:	51                   	push   %ecx
    1081:	51                   	push   %ecx
    1082:	68 68 18 00 00       	push   $0x1868
    1087:	6a 01                	push   $0x1
    1089:	e8 b2 04 00 00       	call   1540 <printf>
    exit();
    108e:	e8 16 03 00 00       	call   13a9 <exit>
    printf(1, "Error munprotect failed\n");
    1093:	52                   	push   %edx
    1094:	52                   	push   %edx
    1095:	68 b4 18 00 00       	push   $0x18b4
    109a:	6a 01                	push   $0x1
    109c:	e8 9f 04 00 00       	call   1540 <printf>
    10a1:	83 c4 10             	add    $0x10,%esp
    10a4:	eb b1                	jmp    1057 <main+0x57>
...
int lock_init(lock_thread *lock)
{
  ...
  printf(1,"12");
    1366:	68 e5 18 00 00       	push   $0x18e5
    136b:	6a 01                	push   $0x1
  ...
  printf(1,"12");
    137b:	58                   	pop    %eax
    137c:	5a                   	pop    %edx
    137d:	68 e5 18 00 00       	push   $0x18e5
    1382:	6a 01                	push   $0x1
    ...
    149c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    14c9:	0f b6 92 48 19 00 00 	movzbl 0x1948(%edx),%edx
    ...
    1549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    15b9:	ff 24 85 f0 18 00 00 	jmp    *0x18f0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    16c7:	90                   	nop
          s = "(null)";
    16c8:	ba e8 18 00 00       	mov    $0x18e8,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    16e1:	a1 94 1c 00 00       	mov    0x1c94,%eax
{
  ...
  freep = p;
    ...
    1721:	5b                   	pop    %ebx
  freep = p;
    1722:	89 15 94 1c 00 00    	mov    %edx,0x1c94
}
    1728:	5e                   	pop    %esi
    1729:	5f                   	pop    %edi
    172a:	5d                   	pop    %ebp
  ...
  freep = p;
    175c:	89 15 94 1c 00 00    	mov    %edx,0x1c94
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    177c:	8b 3d 94 1c 00 00    	mov    0x1c94,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    17c1:	8b 3d 94 1c 00 00    	mov    0x1c94,%edi
  ...
  return freep;
    17ef:	8b 15 94 1c 00 00    	mov    0x1c94,%edx
    ...
    181c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    181f:	89 15 94 1c 00 00    	mov    %edx,0x1c94
}
    ...
    182f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1830:	c7 05 94 1c 00 00 98 	movl   $0x1c98,0x1c94
    1837:	1c 00 00 
    base.s.size = 0;
    183a:	bf 98 1c 00 00       	mov    $0x1c98,%edi
    base.s.ptr = freep = prevp = &base;
    183f:	c7 05 98 1c 00 00 98 	movl   $0x1c98,0x1c98
    1846:	1c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1849:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    184b:	c7 05 9c 1c 00 00 00 	movl   $0x0,0x1c9c
    1852:	00 00 00 
    if(p->s.size >= nunits){
